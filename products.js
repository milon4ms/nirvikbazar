...
const products = [
    // ১. ন্যাচারাল প্রোডাক্ট (Herbal Products)
    {
        ...
        price: 500,
        category: "herbal",
        description: "মালিশের সাথে সাথে চুলকানো বন্ধ হয়। নিয়মিত ব্যবহারে খোসপাচড়া দূর হবে। ব্রণ ও ফুসকুড়ি দ্রুত শুকিয়ে ফেলে। এটি গায়ে মাখলে মশা কামড়ায় না। ১০০% প্রাকৃতিক ও নিরাপদ। পরিমান ২০০ মিলি",
        image: "images/product1.jpg"
    },
    {
        id: 2,
        name: "নির্ভীক পাইলস কেয়ার",
        price: 880,
        category: "herbal",
        description: "পাইলসের ব্যথা, জ্বালা ও রক্তপাত কমাতে বিশেষভাবে কার্যকর।এটি ধীরে ধীরে ভেতর থেকে কাজ করে পাইলস দূর করে। কোষ্ঠকাঠিন্য কমিয়ে স্বাভাবিক মলত্যাগে সহায়তা করে,কোনো পার্শ্বপ্রতিক্রিয়া ছাড়াই ন দীর্ঘমেয়াদে ব্যবহারযোগ্য।
    ...
    // ২. ম্যানস ফ্যাশন (Man's Fashion)
    {
        ...
        price: 1250,
        category: "mens", // ক্যাটাগরি ঠিক করা হয়েছে
    ...
    // ৩. ওমেন্স ফ্যাশন (Womens Fashion)
    {
        ...
        price: 2500,
        category: "womens", // ক্যাটাগরি ঠিক করা হয়েছে
        description: "ঐতিহ্যবাহী টাঙ্গাইল সিল্ক শাড়ি। আকর্ষণীয় ডিজাইন ও উন্নত মানের সুতায় তৈরি।",
        image: "images/product5.jpg"
    },
    {
        id: 6,
        name: "জমকালো কাতান শাড়ি",
        price: 3200,
        category: "womens", 
        description: "বিশেষ অনুষ্ঠানের জন্য উন্নত মানের কাতান শাড়ি।",
    ...
    // ৪. বেবি আইটেম (Baby Items)
    {
        ...
        price: 850,
        category: "kids", // ক্যাটাগরি ঠিক করা হয়েছে
    ...
    // ৬. অনান্য প্রোডাক্ট (Others Products)
    {
        ...
        price: 1800,
        category: "others",
        description: "ওয়াটারপ্রুফ এবং মজবুত ট্রাভেল ব্যাগ।",
