...
const products = [
    // ১. ন্যাচারাল প্রোডাক্ট (Herbal Products)
    {
        ...
        price: 500,
        category: "herbal",
        description: "মালিশের সাথে সাথে চুলকানো বন্ধ হয়। নিয়মিত ব্যবহারে খোসপাচড়া দূর হবে। ব্রণ ও ফুসকুড়ি দ্রুত শুকিয়ে ফেলে। উপাদানঃ নিম, গার্লিক, ক্যামফার, টারমেরিক। শুধু বাহ্যিক ব্যবহারের জন্য।",
